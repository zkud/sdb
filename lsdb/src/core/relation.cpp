...
std::__cxx11::string Relation::toString() const
{
    std::string output = "";
...
Relation Relation::renameAttribute(const std::__cxx11::string &prevName,
                                   const std::__cxx11::string &newName)
{
...
size_t Relation::indexOfAttribute(const std::__cxx11::string &name) const
{
    try
    {
...
Relation Relation::projection(std::list<std::__cxx11::string> attributes)
{
    attributes.unique();
