...
expr:  expr IS NULLX     { beta("ISNULL"); }
   ...
   |   expr IS WinBOOL      { beta("ISBOOL"); }
   |   expr IS NOT WinBOOL  { beta("ISBOOL"); }
...
opt_csc: /* nil */
   | opt_csc WinCHAR SET STRING { free($4); beta("COLCHARSET"); }
...
data_type:
   ...
   | WinINT opt_length opt_uz {beta("INT"); $$ = 40000 + $2 + $3; }
   ...
   | WinDOUBLE opt_length opt_uz { beta("DOUBLE"); $$ = 80000 + $2 + $3; }
   | WinFLOAT opt_length opt_uz { $$ = sdb::types::FLOAT64; }
   | WinDECIMAL opt_length opt_uz { beta("DECIMAL"); $$ = 110000 + $2 + $3; }
   | WinDATE { beta("DATE"); $$ = 100001; }
   | TIME { beta("TIME"); $$ = 100002; }
   | TIMESTAMP { beta("TIMESTAMP"); $$ = 100003; }
   | DATETIME { beta("DATETIME"); $$ = 100004; }
   | YEAR { beta("YEAR"); $$ = 100005; }
   | WinCHAR opt_length opt_csc { beta("CHAR"); $$ = 120000 + $2; }
